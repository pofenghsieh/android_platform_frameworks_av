...
AudioLoopback::AudioLoopback(audio_source_t sourceType, uint32_t channelConfig,
    ...
    mFormat(AUDIO_FORMAT_PCM_16_BIT), mRunning(false),
    mRecordWarm(false), mPrefillBuffer(NULL), mWaitingForStopLock(false)
{
...
status_t AudioLoopback::createRecord()
{
    ...
    mRecord = new AudioRecord(mSourceType, mRate, mFormat, mInChannels, reqFrames,
                              recordCallback, this, kPreferredNotificationFrames, 0,
    ...
    mNotificationFrames = mRecord->notificationFrames();
